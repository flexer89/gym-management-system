...
public class EntranceReportWindow extends JFrame {
    ...
    public EntranceReportWindow(Message message, BufferedReader ReadFromServer, PrintWriter SendToServer, int employeeID) {
        ...
        generateReportButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                message.sendTimeSpentEmployeeReportMessage(SendToServer, entranceFromDate + "," + entranceToDate + "," + entranceFromHour + "," + entranceToHour + "," + exitFromDate + "," + exitToDate + "," + exitFromHour + "," + exitToHour + "," + employeeIDString);
                ...
                try {
                    ...
                    CustomLogger.logError("Error reading report from server: " + ex.getMessage());
                }
            }
        });
