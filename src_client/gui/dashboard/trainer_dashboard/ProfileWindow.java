...
public class ProfileWindow extends JFrame {
    ...
    public ProfileWindow(Message message, BufferedReader ReadFromServer, PrintWriter SendToServer, int trainerID) throws Exception{
        ...
        message.sendGetTrainerMessage(SendToServer, trainerIDString);
        ...
        String dateOfEmployment = responseSplit[5];
        ...
        myProfilePanel.setLayout(new GridLayout(7,1));
        ...
        JLabel dateOfEmploymentLabel = new JLabel("<html><b>Date of Employment: </b> " + dateOfEmployment + "</html>");
        dateOfEmploymentLabel.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 10, 0, 0));
        dateOfEmploymentLabel.setFont(new Font("Arial", Font.PLAIN, 14));
        ...
        myProfilePanel.add(dateOfEmploymentLabel);
