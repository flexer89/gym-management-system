...
public class PaymentReportWindow extends JFrame {
    ...
    public PaymentReportWindow(Message message, BufferedReader ReadFromServer, PrintWriter SendToServer, int userID) {
        ...
        reportTableModel = new DefaultTableModel(new String[]{"ID", "Payment Date", "Amount", "Payment Method"}, 0);
        ...
        generateReportButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                message.sendPaymentReportMessage(SendToServer, fromDate + "," + toDate + "," + minimumPayment + "," + maximumPayment + "," + paymentMethod + "," + String.valueOf(userID));
