...
public class TrainingReportWindow extends JFrame {
    ...
    public TrainingReportWindow(Message message, BufferedReader ReadFromServer, PrintWriter SendToServer, int userID) {
        ...
        generateReportButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                message.sendTrainingReportMessage(SendToServer, name + "," + fromDate + "," + toDate + "," + fromHour + "," + toHour + "," + capacity + "," + room + "," + trainerId + "," + userIDString);
